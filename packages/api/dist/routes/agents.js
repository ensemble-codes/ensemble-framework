...
async function agentRoutes(fastify) {
    ...
    const agentService = new agentService_1.default(fastify.config.RPC_URL, fastify.config.AGENT_REGISTRY_ADDRESS, fastify.config.SERVICE_REGISTRY_ADDRESS);
     ...
     */
    fastify.get('/agents/owner/:ownerAddress', {
        schema: {
            tags: ['agents'],
    ...
    fastify.get('/agents/skills', {
        ...
        try {
            ...
            if (request.query.search) {
                ...
                skills = skills.filter(skill => skill.skill.toLowerCase().includes(searchTerm) ||
